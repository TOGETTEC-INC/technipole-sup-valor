<footer class="py-5" style="background-color: #f7f7f5;">
    <div class="container">
        <div class="row justify-content-between">
            <!-- Logo du Technipole -->
            <div class="col-md-3 mb-4">
                <a class="navbar-brand fw-bold text-orange" href="index.html">
                    <span class="fs-4">T</span>echnipole Sup Valor
                </a>
            </div>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center">
            <p class="mb-2 mb-md-0 text-muted">© 2025 Technipole Sup Valor - Design by <a href="www.togettech.org"
                    target="_blank">TOGETTECH LLC</a></p>
            <div>
